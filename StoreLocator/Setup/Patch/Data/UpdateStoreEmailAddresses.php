...
/**
 * Class UpdateStoreEmailAddresses
 */
class UpdateStoreEmailAddresses implements DataPatchInterface
{
    const JSON_FILE = 'store-location-email';
